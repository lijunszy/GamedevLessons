...
protected:
	...
	*/
	...
	void createBaseScenePass()
	{
		...
		std::string stilized_house_obj = "Resources/Models/stilized_house.obj";
		std::vector<std::string> stilized_house_imgs = {
			"Resources/Textures/stilized_house_bc.png",
			"Resources/Textures/stilized_house_m.png",
			"Resources/Textures/stilized_house_r.png",
			"Resources/Textures/stilized_house_n.png",
			"Resources/Textures/stilized_house_ao.png" };
